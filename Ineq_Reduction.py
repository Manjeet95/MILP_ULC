...
python Ineq_Reduction.py ULC sbox GUROBI -
python Ineq_Reduction.py ULC prob GUROBI -
...
def compute_polytope_halfspaces(vertices):
    ...
    #print(P.get_inequalities())
    #print(len(bA))
    #print(array(P.get_inequalities())[150])
    #print(array(P.get_inequalities())[48])
...
##############################To check  whether some inequalities are not satisfying all possible points###################
# for i in range(0,len(diff_arr_with_1)):
        
#         ineq_solve_count = (np.multiply(np.array(diff_arr_with_1[i]),np.array(ineq_list))).sum(1)
#         less_than_zero = np.where(ineq_solve_count<0)[0]
#         if (len(less_than_zero>0)):
#             print("Possible Point:" + str(diff_arr_with_1[i])+" Ineq Not Satisfied:"+ str(less_than_zero))
#             print(ineq_solve_count)
#         # if( diff_arr_with_1[i] == [1, 1, 1, 1, 1, 0, 0, 1, 0]):
#         #     print(np.array(diff_arr_with_1[i]))
#         #     print(ineq_list[48])
#         #     print(np.array(ineq_list)[48])
#         #     print((np.multiply(np.array(diff_arr_with_1[i]),np.array(ineq_list)[48])))
#         #     print((np.multiply(np.array(diff_arr_with_1[i]),np.array(ineq_list)[48])).sum(1))
